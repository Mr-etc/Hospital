...
<footer class="footer">
        <div class="wrap">
            <div class="footer_section">
                <div class="footer_title-block">
                    <div class="footer_title-block_logo">
                        <svg class="footer_title-block_logo-picture" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="footer_title-block_logo-text"><?=$FooterData['Site_info']['site_name']?></span>
                    </div>
                    <p class="footer_title-block_rights">© <?=date("Y")?>, <?=$FooterData['Site_info']['site_name']?>.<br/>
            ...
            <div class="footer_section">
                <div class="footer_information">
                    <div class="footer_information-item">
                        <div class="footer_information-item_image">
                            <svg  width="19" height="25" viewBox="0 0 19 25">
                                <path d="M17.054 15.183L9.497 25 1.94 15.183a9.445 9.445 0 0 1 0-11.475C3.75 1.343 6.517.001 9.497.001c2.98 0 5.747 1.342 7.557 3.707a9.445 9.445 0 0 1 0 11.475zM4.53 9.217c0 2.718 2.235 4.942 4.967 4.942 2.732 0 4.967-2.224 4.967-4.942 0-2.72-2.235-4.944-4.967-4.944-2.732 0-4.967 2.225-4.967 4.944z"/>
                            </svg>
                        </div>
                        <span class="footer_information-item_title"><?=$FooterData['Site_info']['our_address']?></span>
                    </div>
                    <div class="footer_information-item">
                        <div class="footer_information-item_image">
                            <svg  width="22" height="22" viewBox="0 0 22 22">
                                <path d="M5.983.526l2.63 2.735c.736.631.736 1.788 0 2.525L6.614 7.889c1.368 3.051 4.419 6.102 7.47 7.575l2.104-2.104a1.842 1.842 0 0 1 2.63 0l2.63 2.63a1.842 1.842 0 0 1 0 2.63l-2.63 2.63C14.188 25.878-3.8 7.783.723 3.26L3.353.526a1.84 1.84 0 0 1 2.63 0z"/>
                            </svg>
                        </div>
                        <a href="tel:8<?=$Site_info['our_phone'];?>" class="footer_information-item_title">8 <?php echo preg_replace("~^(\d{3})(\d{3})(\d{2})(\d{2})$~", "($1) $2 $3-$4", $FooterData['Site_info']['our_phone']); ?></a>
                    </div>
                    <div class="footer_information-item">
                        <div class="footer_information-item_image">
                           <svg  width="22" height="14" viewBox="0 0 22 14">
                                <path d="M1.61-.001c-.211 0-.411.045-.596.118l9.34 7.976c.409.35.865.35 1.275 0L20.977.108C20.795.038 20.597 0 20.39 0zM.017 1.379C.006 1.455 0 1.535 0 1.615v10.769c0 .894.718 1.615 1.61 1.615h18.78c.892 0 1.61-.72 1.61-1.615V1.614c0-.079-.006-.159-.017-.235L12.677 9.32a2.606 2.606 0 0 1-3.37 0z"/>
                            </svg>
                        </div>
                        <a href="mail:<?=$FooterData['Site_info']['our_mail'];?>" class="footer_information-item_title"><?=$FooterData['Site_info']['our_mail'];?></a>
                    </div>
                </div>
            </div>
            <div class="footer_section">
                <div class="footer_social-network">
                    <?php
                        foreach($FooterData['social'] as $key => $value):
                            $social_class = preg_replace("~.*_(.*)$~", "$1", $key);
                    ?>
                    <div class="footer_social-network_line <?=$social_class;?>">
                        <a href="<?=$value;?>" target="_blank" class="footer_social-network_line_text"><?=$social_class;?></a>
                    </div>
                    <?php endforeach;?>
                </div>
            </div>
